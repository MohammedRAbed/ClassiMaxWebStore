    ...
    ?>
                    ...
                    method="post" action="">
                        <div class="label font-weight-bold mb-2">
                            Category Name
                            <input type="text" name="new_category" class="form-control bg-light border-1 mb-4 mt-2" 
                            placeholder="Create Category" aria-describedby="basic-addon2">
                        </div>
                        <button type="submit" id="add_cat" name="categoty_submit" class="btn btn-primary shadow-sm">Add Category</button>
                    </form>
                </div>
                <!-- /.container-fluid -->
