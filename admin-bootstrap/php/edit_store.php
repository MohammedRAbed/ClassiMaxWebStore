...
<head>
    ...
    <title>SB Admin 2 - Update Store</title>
                ...
                <div class="container-fluid">
                    ...
                    class="d-none d-sm-block form-block mr-auto ml-md-3 my-2 my-md-0 mw-100" method="post">
                        <div class="label font-weight-bold mb-2">
                            ...
                            placeholder="Store Name" value="<?= $row['name']?>" aria-describedby="basic-addon2">
                        </div>
                        <div class="label font-weight-bold mb-2">
                            Phone
                            <input type="text" name="new_store_phone" class="form-control bg-light border-1 mb-4 mt-2" 
                            placeholder="Store Phone" value="<?= $row['phone']?>" aria-describedby="basic-addon2">
                        </div>
                        <div class="label font-weight-bold mb-4">
                            ...
                            placeholder="Store Address" value="<?= $row['address']?>" aria-describedby="basic-addon2">
                        </div>
                        <div class="label d-sm-block font-weight-bold mb-4">
                            ...
                            <select class="form-control bg-light border-1 mb-4 mt-2" name="category_selection">
                                ...
                                ?>
                                <option <?php if($category_row['id']===$row['category']) {
                                    echo"selected";
    ...
    !empty($_POST['new_store_address']) && !empty($_POST['category_selection'])
        ...
        if(isset($_FILES['new_store_image'])) {
            ...
            if($pic_error === 0) {
                ...
                //Add to Db
                $sql_update_store = "UPDATE `stores` SET 
                `name`='$store_name',`phone`='$store_phone',`address`='$store_address',`category`='$selected_category',
                `img`='$new_img_name' WHERE `id`=$id";
                $r = mysqli_query($conn,$sql_update_store);
                //ob_end_clean();
