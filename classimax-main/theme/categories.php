							...
							<div class="product-item bg-light shadow">
								<div class="card">
									<div class="thumb-content">
										...
										<a class="align-middle" href="single_category.php?store=<?=$store['name']?>">
											<img 
									...
									<div class="card-body">
									    <h4 class="card-title"><a href="single_category.php"><?=$store['name']?></a></h4>
									    <ul class="col product-meta">
									    	<li class="list-inline-item">
									    		<a href="single_category.php"><i class="fa fa-folder-open-o"></i>
												<?php
											...
											<br>
											<li class="list-inline-item">
									    		<a href="single_category.php">Phone: <?=$store['phone']?></a>
									    	</li>
									    	<li class="list-inline-item">
									    		<a href="single_category.php">Address:  <?=$store['address']?></a>
									    	</li>
									    </ul>
